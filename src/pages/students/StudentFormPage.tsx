        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-4">
              <h3 className="text-lg font-medium text-gray-900">수납 및 잔액 현황</h3>
              <input 
                type="month" 
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-xl font-bold text-gray-800">
                {balanceData?.carryOverAmount.toLocaleString() ?? 0}원
              </p>
            </div>
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-600 mb-1">당월 납부액</p>
              <p className="text-xl font-bold text-blue-800">
                {balanceData?.paidAmount.toLocaleString() ?? 0}원
              </p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg">
              <p className="text-sm text-red-600 mb-1">당월 수업료 (사용액)</p>
              <p className="text-xl font-bold text-red-800">
                {balanceData?.usedAmount.toLocaleString() ?? 0}원
              </p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <p className="text-sm text-green-600 mb-1">현재 잔액</p>
          ...
          <div className="text-sm text-gray-500 bg-gray-50 p-4 rounded-md">
            <p>💡 <strong>잔액 계산 방식:</strong></p>
            <p className="mt-1">현재 잔액 = 전월 이월금 + 당월 납부액 - 당월 수업료</p>
            <p className="mt-2 text-xs">* 수업료는 출석/지각/결석 등 수업 기록이 생성될 때마다 자동으로 차감됩니다.</p>
          </div>
        </div>
      )}
